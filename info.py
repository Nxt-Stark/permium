...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<code>{query}</code>\n\n<b>〓〓〓 <a href={url}>{title}</a> 〓〓〓\n\n⭐️ ɪᴍᴅʙ  {rating} | ⏰ ʀᴜɴ {runtime} ᴍɪɴ |\n📆 ʀᴇʟᴇᴀsᴇ ᴅᴀᴛᴇ : {release_date}</b>\n\n● <code>{genres}</code>\n● <code>{languages}</code>\n\n⌚️ <b>Tɪᴍᴇ</b> : <code>{current_time}</code>\n📅 <b>Dᴀᴛᴇ</b> : <code>{current_date}</code>\n\n🥳 <b><i>Today is </i></b><b><i>{current_day}</i></b> <b><i>By <a href='http://t.me/Cinimalokham'>Cinimalokham</i></b></a>")
